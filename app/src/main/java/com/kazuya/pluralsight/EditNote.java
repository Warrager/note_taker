...
public class EditNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button saveButton = (Button)findViewById(R.id.submit);
        final Button cancelButton = (Button)findViewById(R.id.cancelButton);
        final EditText titleEditText=(EditText)findViewById(R.id.title_field);
        final EditText noteEditText=(EditText)findViewById(R.id.note);
